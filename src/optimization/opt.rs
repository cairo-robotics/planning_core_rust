use crate::optimization::gradient::{ForwardFiniteDiff, CentralFiniteDiff, GradientFinder, ForwardFiniteDiffImmutable, CentralFiniteDiffImmutable, GradientFinderImmutable};
...
impl OptimizationEngineNLopt {
    ...
    pub fn optimize(&mut self, x_out: &mut [f64], v: &AgentVars, om: &ObjectiveMaster, max_iter: u32) {
